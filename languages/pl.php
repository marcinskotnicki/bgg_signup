...
return [
    ...
    'profile_password_notice' => 'Musisz podać swoje obecne hasło aby potwierdzić zmiany w profilu.',
    'basic_information' => 'Podstawowe Informacje',
    'display_name' => 'Wyświetlana Nazwa',
    'display_name_visible' => 'Ta nazwa będzie widoczna dla innych użytkowników.',
    'update_name' => 'Zaktualizuj Nazwę',
    'email_address' => 'Adres Email',
    'email_login_notice' => 'Używany do logowania i powiadomień.',
    'update_email' => 'Zaktualizuj Email',
    'password_min_length' => 'Minimum 6 znaków.',
    'update_password' => 'Zaktualizuj Hasło',
    'name_updated' => 'Nazwa została zaktualizowana.',
    'email_updated' => 'Email został zaktualizowany.',
    'password_updated' => 'Hasło zostało zaktualizowane.',
    'all_password_fields_required' => 'Wszystkie pola hasła są wymagane.',
    'current_password_incorrect' => 'Obecne hasło jest nieprawidłowe.',
    'passwords_do_not_match' => 'Nowe hasła nie pasują.',
    'password_too_short' => 'Hasło musi mieć co najmniej 6 znaków.',
    ...
    'email_subject_poll_won' => 'Twój głos wygrał! Zostałeś dodany do {game}',
    'email_body_poll_won' => 'Świetne wieści! Głosowanie zostało zakończone i Twój wybór <strong>{game}</strong> wygrał! Zostałeś automatycznie dodany do tej gry na wydarzenie <strong>{event}</strong>. Do zobaczenia!',
    ...
    'enter_email_for_voting' => 'Wpisz adres email, którego użyłeś podczas głosowania',
    'confirm_cancel_vote' => 'Czy na pewno chcesz anulować swój głos?',
