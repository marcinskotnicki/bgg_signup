...
return [
    ...
    'profile_password_notice' => 'You must provide your current password to confirm any changes to your profile.',
    'basic_information' => 'Basic Information',
    'display_name' => 'Display Name',
    'display_name_visible' => 'This name will be visible to other users.',
    'update_name' => 'Update Name',
    'email_address' => 'Email Address',
    'email_login_notice' => 'Used for login and notifications.',
    ...
    'email_subject_poll_won' => 'Your vote won! You\'ve been added to {game}',
    'email_body_poll_won' => 'Great news! The poll has closed and your choice <strong>{game}</strong> won! You have been automatically added to this game for the event <strong>{event}</strong>. See you there!',
    ...
    'enter_email_for_voting' => 'Enter the email address you used when voting',
